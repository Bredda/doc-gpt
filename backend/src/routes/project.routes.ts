...
router.get(
  ...
  [checkJwt],
  ProjectController.getSpecificChat
);
router.delete(
  '/projects/:projectId/chats/:chatId',
  [checkJwt],
  ProjectController.deleteUserChat
);
router.post(
  '/projects/:projectId/chats',
  [checkJwt],
  ProjectController.createNewProjecthat
);
router.put(
  '/projects/:projectId/chats/:chatId/settings',
  [checkJwt],
  ProjectController.updateChatSettings
);
//CONTEXT
router.post(
